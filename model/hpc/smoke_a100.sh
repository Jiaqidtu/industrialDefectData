...
#BSUB -q gpua100
#BSUB -J yolosam2_smoke
#BSUB -n 4
#BSUB -R "span[hosts=1]"
#BSUB -R "rusage[mem=8GB]"
#BSUB -gpu "num=1:mode=exclusive_process"
#BSUB -W 00:30
#BSUB -o runs/lsf/smoke.%J.out
#BSUB -e runs/lsf/smoke.%J.err
...
python3 -m model.train --data neu-det-yolo --epochs 2 --batch-size 16 \
    --imgsz 640 --workers 4 --eval-every 1 --verbose-eval \
    --project runs --name gpu_smoke $CKPT_ARG
python3 -c "
