...
###
###   STRATEGY=add SEEDS=0,1,2 bsub < model/hpc/ablation_a100.sh
###
...
#BSUB -W 24:00
#BSUB -o runs/lsf/ablation.%J.out
#BSUB -e runs/lsf/ablation.%J.err
...
python3 -m model.ablation \
    ...
    --workers 8 --eval-every 10 --project "runs/ablation_${STRATEGY}" $CKPT_ARG
