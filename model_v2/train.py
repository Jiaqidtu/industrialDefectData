...
def train(cfg: Dict, args) -> Dict:
    ...
    train_loader = build_dataloader(args.data, args.train_split, imgsz=args.imgsz,
    ...
    val_loader = build_dataloader(args.data, args.val_split, imgsz=args.imgsz,
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        if args.close_mosaic and epoch == args.epochs - args.close_mosaic + 1:
            ...
            train_loader = build_dataloader(
                args.data, args.train_split, imgsz=args.imgsz,
                batch_size=args.batch_size, augment=not args.no_aug,
                shuffle=True, workers=args.workers,
...
def get_parser():
    ...
    # architecture
    ap.add_argument("--backbone", default="hiera", choices=["hiera", "cnn", "ultra"],
