...
class YOLOSAM2(nn.Module):
    ...
    def __init__(self, cfg: Optional[Dict] = None):
        ...
        cnn_kwargs = {k: bb.pop(k) for k in
                      ("width", "depth", "use_admsb", "n_admsb") if k in bb}
        if bb_type == "cnn":
            ...
            raise ValueError(f"unknown backbone type {bb_type!r}; use hiera or cnn")
    ...
    def save(self, path: str, extra: Optional[Dict] = None):
        ...
        if (self.cfg["backbone"].get("type", "hiera") == "cnn"
